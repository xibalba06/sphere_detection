...
out_dir = r"C:\Users\def2i\OneDrive\Masaüstü\project see\data"
rgb = "0030.png" # to be changed by you
rgb_path = r"C:\Users\def2i\OneDrive\Masaüstü\project see\png_files"
rgb_image = Image.open(rgb_path)



bbox2d_loose_file_name = "bounding_box_2d_tight_0030.npy"
data = np.load(os.path.join(out_dir, bbox2d_loose_file_name))

# Check for labels
bbox2d_loose_labels_file_name = "bounding_box_2d_tight_labels_0030.json"
with open(os.path.join(out_dir, bbox2d_loose_labels_file_name), "r") as json_data:
    bbox2d_loose_id_to_labels = json.load(json_data)


vis_out_dir = "C:\\Users\\def2i\\OneDrive\\Masaüstü\\project see\\data"
